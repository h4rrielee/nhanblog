...
def home():
    ...
    return render_template('home.html', posts=posts, current="homepage")
...
def reset_token(token):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash(f'Your password has been updated! You are now able to login with your new password', 'success')
        return redirect(url_for('login'))
...
def changepassword():
    ...
    if form.validate_on_submit():
        if bcrypt.check_password_hash(current_user.password, form.old_password.data):
            ...
            flash(f'You have entered a wrong password, please try again!', 'danger')
...
@app.route('/about')
def about():
    return render_template('about.html', title='About', current="about")
